...
- `LLM_BASE_URL` (default the host's port 8080), `LLM_MODEL` and `LLM_API_KEY` reach Engine for NPC dialog and Quests for story authoring; `LLM_TIMEOUT_MS` reaches Engine. `VOICE_BASE_URL` (default `http://voice:8080`) points Engine at Voice.
